        ...
        <div className="home">
            ...
            <section className="section" style={{ textAlign: 'center' }}>
                <div className="container">
                    ...
                    <a href="https://www.instagram.com/hitcellmacae_?stkn=cDJ1Z3EwcnQ2cjFq" target="_blank" rel="noopener noreferrer" className="btn btn-outline btn-lg" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
